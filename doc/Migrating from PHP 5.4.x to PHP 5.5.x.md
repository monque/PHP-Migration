...
- [x] [New Functions](migration55.new-functions.php)
- [x] [New Classes and Interfaces](migration55.classes.php)
- [ ] [New Methods](migration55.new-methods.php)
- [ignore] [Other changes to extensions](migration55.extensions-other.php)
- [x] [New Global Constants](migration55.global-constants.php)
- [ignore] [Changes to INI file handling](migration55.ini.php)
- [ignore] [Changes to PHP Internals](migration55.internals.php)
